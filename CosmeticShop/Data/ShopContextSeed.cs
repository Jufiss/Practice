...
namespace CosmeticShop.Data
{
    public class ShopContextSeed
    {
        public static async Task SeedAsync(ShopContext context)
        {
            ...
            //                var firms = new SexCategory[]
            //{
            //                        new SexCategory{Name="Vivienne Sabo"},
            //                        new SexCategory{Name="Tom Ford"},
            //};
            //                foreach (SexCategory b in firms)
            //                {
            //                    context.Firm.Add(b);
            //                }
            //                await context.SaveChangesAsync();
            ...
            //                //{
            //                //        new Product{Name="Nude Createur", CategoryId=2, ColorId=1, Count=15, Price=400, FirmId=1, Description="Новая помада Nude Créateur вдохновит тебя на творчество в ежедневном макияже!"},
